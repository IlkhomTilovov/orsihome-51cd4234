...
export function ProductCard({ product, eager = false }: ProductCardProps) {
  ...
  return (
    <article className="group relative bg-background rounded-2xl overflow-hidden border border-border/40 shadow-soft-md hover:shadow-soft-lg transition-shadow duration-300">
