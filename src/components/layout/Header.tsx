...
export function Header() {
  ...
  return (
    ...
    >
      ...
      {catalogOpen && (
        <>
          <div className="fixed left-0 right-0 bottom-0 top-[var(--header-h,80px)] z-40 bg-black/40 backdrop-blur-sm animate-fade-in" onClick={() => setCatalogOpen(false)} style={{ top: '100%' }} />
