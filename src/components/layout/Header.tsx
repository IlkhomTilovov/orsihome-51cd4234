          ...
          return (
            <>
              <div
                ...
                onClick={() => setCatalogOpen(false)}
              />
              <div className="fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-[70] max-w-[95%] w-[95%] h-[95%] p-3 flex gap-3 animate-fade-in transition-all duration-300">
                {/* Dark left sidebar */}
                <aside
