...
export const ATTRIBUTE_ICONS: AttributeIconDef[] = [
  ...
  { key: 'hammer', label: 'Ishlab chiqarish', Icon: Hammer },
  { key: 'wrench', label: 'Yig\'ilish', Icon: Wrench },
  { key: 'box', label: 'Qadoq', Icon: Box },
  { key: 'package', label: 'Komplekt', Icon: Package },
  { key: 'truck', label: 'Yetkazish', Icon: Truck },
  { key: 'warehouse', label: 'Ombor', Icon: Warehouse },
  { key: 'shield', label: 'Kafolat', Icon: Shield },
  { key: 'award', label: 'Sifat', Icon: Award },
  { key: 'star', label: 'Xususiyat', Icon: Star },
  { key: 'sparkles', label: 'Yangi', Icon: Sparkles },
