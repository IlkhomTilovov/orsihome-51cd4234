                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <Input
                        ...
                        className="h-12 rounded-lg border-border/50 bg-muted px-5 py-3.5 tracking-wide text-foreground placeholder:text-muted-foreground/80 focus:border-primary focus:bg-background transition-colors"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="rounded-lg border-border/50 bg-muted px-5 py-3.5 leading-relaxed tracking-wide text-foreground placeholder:text-muted-foreground/80 focus:border-primary focus:bg-background transition-colors resize-none"
                    />
                  </div>
